  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center text-white">
      ...
      <div className="relative z-10 w-full max-w-6xl px-4 md:px-8 py-10 md:py-16">
        ...
        <div className="bg-blue-800 rounded-lg shadow-2xl p-4 md:p-6">
...
//             {/* Destination Input */}
//             <div className="flex flex-col md:col-span-2">
//               <label htmlFor="destination" className="text-sm font-semibold text-gray-700 mb-1">
//                 Where are you going?
//               </label>
//               <div className="relative">
//                 <input
...
//               <button
//                 type="button"
//                 className="w-full md:w-auto bg-blue-600 text-white font-bold px-8 py-3 rounded-lg hover:bg-blue-700 transition flex items-center justify-center gap-2"
//               >
//                 {/* Use the Lucide Search icon */}
//                 <Search size={20} /> Search
//               </button>
